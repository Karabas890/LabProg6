...
public class InputReader {
    ...
    public Chapter GetChapter(String chapterName,String parentLegion) {
        try {
            return new Chapter(
                    chapterName,parentLegion
            );
        } catch (Exception e) {
            System.out.println(e.getMessage());
            return GetChapter();
    ...
    public Coordinates GetCoordinates(float x,int y) {
        try {
            return new Coordinates(
                    x,y
            );
    ...
    public <E extends Enum<E>> E GetEnumValue(Class<E> enumClass,String value) {
        try {
            E[] enumConstants = enumClass.getEnumConstants();
            // Check if the input is a number
            if (value.matches("\\d+")) {
    ...
    public  SpaceMarine GetSpaceMarine(String name, float x,int y, int health, String achievements,
                                           AstartesCategory astartesCategory,WeaponType weapon, String chapterName,String parentLegion) throws Exception {
        try {
            return new SpaceMarine(
                    0,
                    name,
                    ...
                    astartesCategory,
                    weapon,
                    GetChapter(chapterName,parentLegion)
            );
        } catch (Exception e) {
